...
-- 4. List the department number of each employee along with that employee's employee number, last name, first name, 
-- and department name.
...
-- 5. List first name, last name, and sex of each employees whose first name is "Hercules" and 
-- whose last name begin with the letter "B."
...
-- 8. List the frequency counts, in descending order, of all the employees last names, (that is how many employees 
